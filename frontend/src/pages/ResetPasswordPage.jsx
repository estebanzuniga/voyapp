        ...
        <div className="mx-auto w-full max-w-sm">
          ...
          {!token ? (
            <div className="flex flex-col gap-3">
              ...
              <p className="max-w-[34ch] text-muted">{t('resetPassword.invalidLinkBody')}</p>
            ...
            <>
              ...
              <p className="mb-8 max-w-[34ch] text-muted">{t('resetPassword.subtext')}</p>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                >
                  {loading ? t('common.saving') : t('resetPassword.saveNewPassword')}
                </button>
              </form>
